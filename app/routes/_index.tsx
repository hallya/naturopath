      ...
      <main className="mainContainer">
          ...
          <div className="service-content">
            <div className="service-intro">
              <p className="service-highlight">
                ...
                depuis 2001. Elle vise à maintenir ou restaurer la santé par des moyens naturels, en
                suivant le principe fondamental d&apos;Hippocrate : &quot;d&apos;abord ne pas
                nuire&quot;.
              </p>
            </div>
            ...
            <div className="service-details">
              <article className="info-card">
                ...
                <p>
                  ...
                  l&apos;interdépendance entre le corps et l&apos;esprit. Elle travaille en
                  complémentarité avec la médecine conventionnelle pour accompagner chacun vers un
                  meilleur équilibre de santé.
                </p>
              </article>
              ...
              <article className="info-card consultation-info">
                ...
                <p>
                  ...
                  conseils personnalisés dans les 48 heures. Le rythme des séances est adapté à
                  chacun, pouvant être mensuel, trimestriel ou saisonnier selon vos besoins.
                </p>
              </article>
            </div>
          </div>
            ...
            <div className="service-details">
              <article className="info-card">
                ...
                <p>
                  ...
                  pressions et lissages précis sur des zones réflexes spécifiques. Chaque point
                  travaillé correspond à une projection d&apos;un organe, permettant d&apos;agir à
                  distance sur l&apos;ensemble du corps.
                </p>
              </article>
              ...
              <article className="info-card">
                ...
                <p>
                  Ancrée dans la Médecine Traditionnelle Chinoise, la réflexologie plantaire partage
                  ses fondements avec l&apos;acupression, le shiatsu et l&apos;acupuncture. Son
                  histoire remonte à plus de 5000 ans, avec des traces retrouvées en Chine et en
                  Égypte ancienne, notamment sur le sarcophage d&apos;Ankhmahor (2330 av. J.-C.).
                </p>
                <p>
        ...
        <section ref={sections.massage.ref} className="section" id={sections.massage.hash}>
          ...
          <div className="service-content">
            <div className="service-intro">
              <p className="service-highlight">
                Le massage bien-être est une approche naturelle et holistique qui vise à harmoniser
                le corps et l&apos;esprit. En tant que naturopathe, je vous accompagne sur le chemin
              ...
              <div className="contact-card">
                ...
                <div className="contact-item">
                  ...
                  <div className="contact-details">
                    <h3>Téléphone</h3>
                    <p>
                      <a href="tel:+33764189601" className="phone-link">07 64 18 96 01</a>
                    </p>
                  </div>
                </div>
              </div>
